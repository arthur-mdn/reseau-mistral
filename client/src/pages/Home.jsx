                            ...
                            <div>
                                ...
                                <div>
                                    {ticketsEnCours.map(ticket => (
                                        <Link key={ticket._id} to={`/tickets/${ticket._id}`} style={{backgroundColor:"white", marginTop:'0.25rem',padding:"0.5rem", borderRadius:"0.5rem", color:"black"}} className={"fr ai-c g0-5"}>
